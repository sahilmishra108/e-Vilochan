...
const QuickAdmitDialog = ({ trigger }: QuickAdmitDialogProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (icuMode === 'new') {
                const icuRes = await authFetch(`${API_BASE_URL}/api/icus`, {
                    method: "POST",
            ...
            // 2. Create Patient
            const patientRes = await authFetch(`${API_BASE_URL}/api/patients`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    ...patientData,
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[85vh] overflow-y-auto bg-white/95 backdrop-blur-xl border-white/20 shadow-2xl p-0 gap-0">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="space-y-4 pt-2">
                        <div className={`flex items-start space-x-3 p-4 rounded-lg border ${parseInt(patientData.age || '0') < 18 ? 'bg-amber-50/50 border-amber-200' : 'bg-blue-50/50 border-blue-100'}`}>
                            <Checkbox
                                id="consent"
                    ...
                    <DialogFooter className="pt-4">
                        ...
                        <Button type="submit" disabled={loading || !consentGiven} className="bg-primary hover:bg-primary/90 text-lg px-8">
